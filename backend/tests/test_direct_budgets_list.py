...
def main():
    """Test script for the direct budgets-list endpoint"""
    print("===== TESTING DIRECT BUDGETS LIST ENDPOINT =====")
    ...
    # Step 2: Test the direct budgets-list endpoint
...
def test_direct_endpoint(token):
    """Test the direct budgets-list endpoint"""
    try:
